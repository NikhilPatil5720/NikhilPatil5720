...
<div style="display:flex; flex-wrap:wrap; gap:15px; justify-content:flex-start;">
  <div style="padding:15px; border-radius:12px; background:#e0f7fa; transition:all 0.3s; box-shadow:0 3px 10px rgba(0,0,0,0.1); margin-bottom:15px;" 
       onmouseover="this.style.transform='scale(1.05)';" 
       onmouseout="this.style.transform='scale(1)';">
    📅 <strong>IBM Full Stack Web Development</strong>
    
  </div>
  <div style="padding:15px; border-radius:12px; background:#fff3e0; transition:all 0.3s; box-shadow:0 3px 10px rgba(0,0,0,0.1); margin-bottom:15px; " 
       onmouseover="this.style.transform='scale(1.05)';" 
       onmouseout="this.style.transform='scale(1)';">
    📈 <strong>Microsoft Project Management Essentials – LinkedIn</strong> *(Feb 2025)*
    
  </div>
  <div style="padding:15px; border-radius:12px; background:#e8f5e9; transition:all 0.3s; box-shadow:0 3px 10px rgba(0,0,0,0.1); margin-bottom:15px;" 
       onmouseover="this.style.transform='scale(1.05)';" 
       onmouseout="this.style.transform='scale(1)';">
    📚 <strong>Cisco CCNAv7 - Networking (Distinction)</strong>
    
  </div>
  <div style="padding:15px; border-radius:12px; background:#f3e5f5; transition:all 0.3s; box-shadow:0 3px 10px rgba(0,0,0,0.1); margin-bottom:15px;" 
       onmouseover="this.style.transform='scale(1.05)';" 
       onmouseout="this.style.transform='scale(1)';">
